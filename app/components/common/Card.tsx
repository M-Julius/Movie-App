...
const $containerBase: ViewStyle = {
  ...
  padding: spacing.xs,
  borderWidth: 1,
  shadowColor: colors.palette.lighterGrey,
...
const $containerPresets = {
  ...
  reversed: [
    $containerBase,
    { backgroundColor: colors.palette.lightGrey, borderColor: colors.palette.lightGrey },
  ] as StyleProp<ViewStyle>,
}

const $headingPresets: Record<Presets, TextStyle> = {
  default: {},
  reversed: { color: colors.palette.lightGrey },
}
